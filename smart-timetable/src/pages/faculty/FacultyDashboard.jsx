...
const FacultyDashboard = () => {
        ...
        const loadData = async () => {
            ...
            try {
                ...
                /*
                  ...
                  If the faculty record was created before
                  userId was linked, facultyService can use
                  employeeId from profile as fallback.
                */
                ...
                if (!facultyProfile) {
                    ...
                    setError(
                        "Faculty profile was not found. Please make sure your Firebase user has a matching employeeId in the users collection and that the same employeeId exists in the faculty collection."
                    );
                ...
                /*
                  Now load only the data relevant to
                  this faculty member.
                */
    ...
    /* =========================================================
       EVERYTHING BELOW THIS LINE IS SAFE BECAUSE
       FACULTY EXISTS
    ========================================================= */

    /*
      Get ONLY this faculty's timetable entries.
    */

    const facultyClasses = timetables.flatMap(
        (timetable) =>
            (timetable.schedule || [])
                .filter(
                    (item) =>
    ...
    /*
      Currently Admin configuration stores
      period duration globally.
  
      Since the timetable items don't currently
      carry college config here, we use 50 minutes
      as the display conversion.
    */
